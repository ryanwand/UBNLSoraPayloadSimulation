...
exposure = 60; %The exposure time in seconds
exposureoptics = 30; %Exposure time for aperture calculation

%Make a new script similar to OpticalFeed
aperture = 6.07;%OpticalFeed(1.5,2,wavelengthBottom,wavelengthTop,bin,eff1,eff2,550,exposureoptics,appmag,setup);
...
payloadModelGC(wavelengthTop, wavelengthBottom, binSize, apparentMagnitude, aperture, specReflProfile, sysEff, T, exposure)